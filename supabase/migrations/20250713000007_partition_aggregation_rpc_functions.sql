-- パーティション対応の集計RPC関数
-- 複数月データの統合とAnalyticsRepositoryで使用する関数
...
VALUES ('20250713000007', 'Created partition-aware aggregation RPC functions', NOW())
