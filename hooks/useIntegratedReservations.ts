...
export type IntegratedReservation = {
  ...
  isFreeNomination: boolean | undefined
  status: string
...
export function useIntegratedReservations({
  ...
  const fetchSupabaseReservations = useCallback(
    async (page: number, reset: boolean = false) => {
      console.log('[useIntegratedReservations] fetchSupabaseReservations called:', {
        tenantId,
        orgId,
        customerUid,
        status,
      ...
      try {
        ...
        const converted = data
          ...
          .map((item) => ({
            ...
            _convex_id: item.reservation._convex_id,
            ...
            isFreeNomination: item.reservation.is_free_nomination ?? undefined,
        ...
        console.log('[useIntegratedReservations] Supabase data fetched successfully:', {
