...
// スタッフスケジュールのバリデーション
function validateStaffSchedule(args: Partial<Doc<"staff_schedule">>) {
...
export const add = mutation({
  ...
  handler: async (ctx, args) => {
    try {
      ...
      handleConvexApiError("スタッフスケジュールの追加に失敗しました", ERROR_CODES.INTERNAL_ERROR, error);
    }
  },
});
...
export const update = mutation({
  ...
  handler: async (ctx, args) => {
    try {
      ...
      handleConvexApiError("スタッフスケジュール情報の更新に失敗しました", ERROR_CODES.INTERNAL_ERROR, error);
    }
  },
});
...
export const trash = mutation({
  ...
  handler: async (ctx, args) => {
    try {
      ...
      handleConvexApiError("スタッフスケジュールのアーカイブに失敗しました", ERROR_CODES.INTERNAL_ERROR, error);
    }
  },
});
...
export const upsert = mutation({
  ...
  handler: async (ctx, args) => {
    try {
      ...
      handleConvexApiError("スタッフスケジュールの追加/更新に失敗しました", ERROR_CODES.INTERNAL_ERROR, error);
    }
  },
});
...
export const kill = mutation({
  ...
  handler: async (ctx, args) => {
    try {
      ...
      handleConvexApiError("スタッフスケジュールの削除に失敗しました", ERROR_CODES.INTERNAL_ERROR, error);
    }
  },
});
...
export const getBySalonStaffAndWeek = query({
  ...
  handler: async (ctx, args) => {
    return await ctx.db
      ...
      .withIndex("by_salon_staff_week", (q) => 
