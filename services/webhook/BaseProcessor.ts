  ...
  public async process(req: NextRequest, secret: string): Promise<NextResponse> {
    ...
    try {
      ...
      const metrics = new WebhookMetricsCollector({
        ...
        stripeAccountId: metricMetadata.stripeAccountId,
        stripeCustomerId: metricMetadata.stripeCustomerId,
        stripeSubscriptionId: metricMetadata.stripeSubscriptionId,
      });
