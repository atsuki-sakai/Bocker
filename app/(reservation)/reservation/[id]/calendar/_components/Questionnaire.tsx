          ...
          {step === totalSteps && (
            <div className="flex flex-col gap-6 mt-4">
              ...
              <div className="">
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex justify-between items-center">
                    <span className="text-slate-500 font-medium w-24">ご希望</span>
                  ...
                  {form.getValues().styleWishType.includes('specific') && (
                    <div className="flex justify-between items-center w-full">
                      <span className="text-slate-500 font-medium w-1/3">具体的な希望</span>
                  ...
                  {form.getValues().styleWishType.includes('image') && (
                    <div className="flex justify-between items-center w-full">
                      <span className="text-slate-500 font-medium w-1/3">理想のイメージ</span>
                      <span className="text-black font-semibold w-2/3 text-end">
                        {hairImgFile?.name || <span className="text-gray-400">未入力</span>}
                      </span>
                    </div>
                  )}
                </div>
              ...
              <div className="">
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex justify-between items-center">
                    <span className="text-slate-500 font-medium w-24">目的</span>
                    <span className="flex flex-wrap gap-1 justify-end">
                  ...
                  {form.getValues().purpose.includes('other') && (
                    <div className="flex justify-between items-center w-full">
                      <span className="text-slate-500 font-medium w-1/3">その他の内容</span>
                      <span className="text-black font-semibold w-2/3 text-end">
              ...
              <div className="">
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex justify-between items-center">
                    <span className="text-slate-500 font-medium w-24">満足度</span>
                    <span className="text-black font-semibold w-2/3 text-end">
                  ...
                  {form.getValues().satisfaction === 'bad' && (
                    <div className="flex justify-between items-center w-full">
                      <span className="text-slate-500 font-medium w-1/3">不満の理由</span>
                      <span className="text-black font-semibold w-2/3 text-end">
                  ...
                  <div className="flex justify-between items-center w-full">
                    ...
                    <span className="text-black font-semibold w-2/3 text-end">
                      {form.getValues().likePoint || <span className="text-gray-400">未入力</span>}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="">
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex justify-between items-center">
                    <span className="text-slate-500 font-medium w-24">長さ</span>
                    <span className="text-black font-semibold w-2/3 text-end">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-slate-500 font-medium w-24">前髪</span>
                    <span className="text-black font-semibold w-2/3 text-end">
                  ...
                  {form.getValues().frontHair === 'make' && (
                    <div className="flex justify-between items-center w-full">
                      <span className="text-slate-500 font-medium w-1/3">前髪の長さ</span>
                      <span className="text-black font-semibold w-2/3 text-end">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-slate-500 font-medium w-24">量・重さ</span>
                    <span className="text-black font-semibold w-2/3 text-end">
              ...
              <div className="">
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex justify-between items-center">
                    <span className="text-slate-500 font-medium w-24">髪質</span>
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-slate-500 font-medium w-24">ボリューム感</span>
                    <span className="text-black font-semibold w-2/3 text-end">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-slate-500 font-medium w-24">頭皮の状態</span>
                    <span className="flex flex-wrap gap-1 justify-end w-2/3">
              ...
              <div className="">
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex justify-between items-center">
                    <span className="text-slate-500 font-medium w-24">普段の方法</span>
                    <span className="flex flex-wrap gap-1 justify-end w-2/3">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-slate-500 font-medium w-24">スタイリング時間</span>
                    <span className="text-black font-semibold w-2/3 text-end">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-slate-500 font-medium w-24">シャンプー</span>
                    <span className="text-black font-semibold w-2/3 text-end">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-slate-500 font-medium w-24">トリートメント</span>
                    <span className="text-black font-semibold w-2/3 text-end">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-slate-500 font-medium w-24">スタイリング剤</span>
                    <span className="text-black font-semibold w-2/3 text-end">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-slate-500 font-medium w-24">困っていること</span>
                    <span className="text-black font-semibold w-2/3 text-end">
              ...
              <div className="">
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex justify-between items-center">
                    <span className="text-slate-500 font-medium w-24">職場や学校の規定</span>
                    <span className="text-black font-semibold w-2/3 text-end">
              ...
              <div className="">
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex justify-between items-center">
                    <span className="text-slate-500 font-medium w-24">カラー履歴</span>
                    <span className="text-black font-semibold w-2/3 text-end">
                  ...
                  {form.getValues().colorHistory === 'yes' && (
                    <>
                      <div className="flex justify-between items-center w-full">
                        <span className="text-slate-500 font-medium w-1/3">最終カラー時期</span>
                        <span className="text-black font-semibold w-2/3 text-end">
                      ...
                      <div className="flex justify-between items-center w-full">
                        <span className="text-slate-500 font-medium w-1/3">カラーの色</span>
                        <span className="text-black font-semibold w-2/3 text-end">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-slate-500 font-medium w-24">パーマ／縮毛矯正履歴</span>
                    <span className="text-black font-semibold w-2/3 text-end">
                  ...
                  {['perm', 'straight'].includes(form.getValues().permHistory) && (
                    <div className="flex justify-between items-center w-full">
                      <span className="text-slate-500 font-medium w-1/3">最終パーマ時期</span>
                      <span className="text-black font-semibold w-2/3 text-end">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-slate-500 font-medium w-24">ブリーチ履歴</span>
                    <span className="text-black font-semibold w-2/3 text-end">
                  ...
                  {form.getValues().bleachHistory === 'yes' && (
                    <>
                      <div className="flex justify-between items-center w-full">
                        <span className="text-slate-500 font-medium w-1/3">ブリーチ回数</span>
                        <span className="text-black font-semibold w-2/3 text-end">
                      ...
                      <div className="flex justify-between items-center w-full">
                        <span className="text-slate-500 font-medium w-1/3">ブリーチ部分</span>
                        <span className="text-black font-semibold w-2/3 text-end">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-slate-500 font-medium w-24">傷みの気になる箇所</span>
                    <span className="text-black font-semibold w-2/3 text-end">
              ...
              <div className="">
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex justify-between items-center">
                    <span className="text-slate-500 font-medium w-24">ご希望・ご質問</span>
                    <span className="text-black font-semibold w-2/3 text-end">
