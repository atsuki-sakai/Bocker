...
type PointViewProps = {
  ...
  selectedStaffConfig: Doc<'staff_config'> | null
  // クーポン関連のpropsを追加
...
export const PointView = ({ 
  ...
  const calculateExtraCharge = () => {
    return selectedStaffConfig?.extraCharge || 0
  }
        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center text-sm">
              ...
              <span>施術時間: {hours > 0 ? `${hours}時間` : ''} {minutes > 0 ? `${minutes}分` : ''}</span>
            </div>
            ...
            {appliedCoupon && (
              <div className="mt-2 p-2 bg-green-50 border border-green-200 rounded-md">
                <p className="text-green-700 text-sm flex items-center">
                  ...
                  クーポン「{appliedCoupon.code}」が適用されました（{appliedCoupon.discount.toLocaleString()}円割引）
                </p>
              </div>
            )}
          </div>
