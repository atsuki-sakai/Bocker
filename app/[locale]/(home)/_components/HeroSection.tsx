  ...
  <div className="relative isolate">
        ...
        <div className="mx-auto max-w-7xl px-6 pt-36 pb-32 sm:pt-60 lg:px-8 lg:pt-32">
            ...
            <div className="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
                <h1 className="text-5xl font-semibold tracking-tight  text-links-foreground sm:text-7xl">
                {t('title')}
                </h1>
                <p className="mt-8 text- text-pretty text-muted-foreground sm:max-w-md sm:text-xl/8 lg:max-w-none">
                {t('subtitle')}
                </p>
                ...
                <Link href="#" className="text-sm/6 font-semibold text-foreground underline underline-offset-4 tracking-wide">
