  ...
  const faqData = {
    ja: [
      ...
      },
      {
        ...
        answer:
          'LITEプラン（月額8,000円/年額80,000円）はサロン運営に必要な基本機能を網羅し、予約件数は月500件、顧客登録数500人、スタッフ3人、メニュー20点、オプション15点、クーポン10点まで対応。PROプラン（月額12,000円/年額120,000円）はLITEの全機能に加え、カルテ画像4枚・音声入力、メニュー60点、スタッフ10人、オプション30点、クーポン30点、予約数・顧客数は無制限。どちらも30日間無料トライアル・解約手数料なし・いつでもプラン変更可能です。',
      },
      {
