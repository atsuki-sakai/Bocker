          ...
          <div className="relative flex flex-col items-center justify-center">
            ...
            >
              ...
              <motion.div
                ...
                className="absolute inset-0 w-32 h-32 border-2 border-primary/20 rounded-full"
              />
              ...
              <motion.div
                ...
                className="relative z-10 w-28 h-28 flex items-center justify-center bg-white rounded-full p-4 shadow-lg"
              >
                <Image
