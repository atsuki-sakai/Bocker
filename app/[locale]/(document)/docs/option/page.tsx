    ...
    <div className="max-w-4xl mx-auto space-y-4 md:space-y-8">
      ...
      <div className="space-y-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm md:text-base">追加サービス・物販商品の管理・在庫管理の詳細操作方法</p>
          </div>
        </div>
        <div className="flex flex-wrap gap-2">
          <Badge variant="secondary">在庫管理</Badge>
          <Badge variant="secondary">物販商品</Badge>
          <Badge variant="secondary">追加サービス</Badge>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <Alert>
            ...
            <AlertDescription>
              <strong>プラン別上限:</strong> LITEプラン: 最大5個 / PROプラン: 最大10個
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3 p-3 bg-link rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">/dashboard/option</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3 p-3 bg-link rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">/dashboard/option/add</p>
                  </div>
                </div>
              </div>
              <div className="space-y-3">
                <div className="flex items-center space-x-3 p-3 bg-link rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">/dashboard/option/[option_id]/edit</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="p-4 bg-muted rounded-lg text-sm">
            ...
            <div className="text-xs text-muted-foreground space-y-1">
              <p>ダッシュボード → サイドメニュー「オプション」→ オプション一覧画面</p>
              <p>オプション一覧画面 → 「オプションを作成」ボタン → オプション追加画面</p>
              <p>オプション一覧画面 → 各オプションの「編集」ボタン → オプション編集画面</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="space-y-4">
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                <h4 className="font-semibold text-foreground text-sm md:text-base">オプション追加画面を開く</h4>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <div className="mt-2 space-y-2">
                  <div className="p-3 bg-muted rounded-lg">
                    <p className="font-medium text-sm">オプションメニュー名（必須）</p>
                    <p className="text-sm text-muted-foreground">例：「ヘッドスパ15分」「シャンプー（500ml）」</p>
                  </div>
                  <div className="p-3 bg-muted rounded-lg">
                    <p className="font-medium text-sm">最大注文数（必須、デフォルト：1）</p>
                    <p className="text-sm text-muted-foreground">1回の予約で選択できる最大数</p>
                  </div>
                  <div className="p-3 bg-muted rounded-lg">
                    <p className="font-medium text-sm flex items-center space-x-2">
              ...
              <div className="flex-1">
                ...
                <div className="mt-2 space-y-2">
                  ...
                  <div className="p-3 bg-muted rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground">通常価格より低い金額を設定（空欄可）</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="flex-1">
                ...
                <div className="mt-2 space-y-2">
                  <div className="p-3 bg-muted rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground">例：「人気」「期間限定」「新商品」</p>
                  </div>
                  <div className="p-3 bg-muted rounded-lg">
                  ...
                  <div className="p-3 bg-muted rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground">ON: 予約画面に表示 / OFF: 非表示</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              <div className="flex-shrink-0 w-8 h-8 bg-primary text-primary-foreground rounded-full flex items-center justify-center text-sm font-bold">7</div>
              <div className="flex-1">
                <h4 className="font-semibold text-foreground">「オプションを追加」ボタンをクリックして完了</h4>
          ...
          <Alert variant="destructive">
            ...
            <AlertDescription>
              <strong>重要:</strong> 在庫が0になると自動的に選択不可になります。物販商品は実際の在庫数を正確に設定してください。
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-6">
          <div className="space-y-4">
            <div className="p-4 bg-muted rounded-lg">
              <h4 className="font-semibold text-foreground mb-2">シナリオA: 物販商品（シャンプー）の登録</h4>
            ...
            <div className="p-4 bg-muted rounded-lg">
              <h4 className="font-semibold text-foreground mb-2">シナリオB: 施術サービス（ヘッドスパ）の登録</h4>
              <p className="text-sm text-muted-foreground mb-3">
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="p-3 bg-destructive/10 rounded-lg">
                  <p className="font-medium text-destructive text-sm">「セール価格は通常価格より低く設定してください」</p>
                  <p className="text-destructive/90 text-xs mt-1">セール価格を通常価格より低い金額に変更するか、セール価格を空欄に</p>
                </div>
                <div className="p-3 bg-warning/10 rounded-lg">
                  <p className="font-medium text-warning text-sm">「在庫が不足しています」</p>
                  <p className="text-warning/90 text-xs mt-1">在庫数を確認し、必要に応じて更新してください</p>
                </div>
                <div className="p-3 bg-info/10 rounded-lg">
                  <p className="font-medium text-info text-sm">「画像のアップロードに失敗しました」</p>
                  <p className="text-info/90 text-xs mt-1">画像を圧縮してから再度アップロード、またはネットワーク接続を確認</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-sm text-muted-foreground">
                <div className="flex items-start space-x-2">
                  ...
                  <span>物販商品は定期的に在庫数を更新しましょう</span>
                </div>
                <div className="flex items-start space-x-2">
                  <CheckCircle className="h-4 w-4 text-success mt-0.5 flex-shrink-0" />
                  <span>施術時間の設定ミスは予約システムに影響します</span>
                </div>
                <div className="flex items-start space-x-2">
                  <CheckCircle className="h-4 w-4 text-success mt-0.5 flex-shrink-0" />
                  <span>価格設定は保存前に必ず再確認</span>
                </div>
                <div className="flex items-start space-x-2">
                  <CheckCircle className="h-4 w-4 text-success mt-0.5 flex-shrink-0" />
                  <span>高品質な画像で商品・サービスの魅力を伝えましょう</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-4">
            <div>
              <h4 className="font-semibold text-foreground">Q: 在庫が0になったらどうなりますか？</h4>
              <p className="text-sm text-muted-foreground mt-1">
                A: 自動的にお客様の予約画面で選択不可になります。在庫を追加すると再び選択可能になります。
              </p>
            </div>
            <div>
              <h4 className="font-semibold text-foreground">Q: 施術時間を後から変更できますか？</h4>
              <p className="text-sm text-muted-foreground mt-1">
                A: はい、編集画面から変更可能です。ただし、既存の予約には影響しません。
              </p>
            </div>
            <div>
              <h4 className="font-semibold text-foreground">Q: 削除したオプションを復元できますか？</h4>
              <p className="text-sm text-muted-foreground mt-1">
                A: いいえ、一度削除したオプションは復元できません。削除前に十分確認してください。
              </p>
            </div>
            <div>
              <h4 className="font-semibold text-foreground">Q: 物販と施術サービスを見分ける方法は？</h4>
              <p className="text-sm text-muted-foreground mt-1">
      ...
      <Card className="bg-link border-border">
        ...
        <CardContent className="space-y-3">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <h4 className="font-semibold text-link-foreground mb-2">権限について</h4>
              <p className="text-sm text-link-foreground">
                マネージャー以上の権限が必要
              </p>
              <p className="text-xs text-link-foreground mt-1">データは自動的にバックアップされます</p>
            </div>
          </div>
        </CardContent>
      </Card>
